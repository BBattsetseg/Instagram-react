...
const Post = (props) => {
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const clickLike = () => {
          let doc = document.querySelector('.heart');
                ...
                <div className="post card">
                        <ul className="collection">
                            <li className="collection-item avatar valign-wrapper">
                                ...
                                <p>{props.postedUser}</p>
                                <a href="#!" className="secondary-content" onClick={modalBox}><i className="material-icons">more_horiz</i></a>
                            </li>
                        </ul>
                        ...
                        <ul className="collection">
                            <li className="collection-item row">
                                <div className=" col s12 groupIcons">
                                    ...
                                    <a href="#!" className="secondary-content  right grey-text"><i className="small material-icons">bookmark_border</i></a>   
                                </div>
                                <div className="row likedBy">
                                    <div className="likedByUsers col s6">
                                        <span>Liked by </span><b>{props.likes} </b>                   
                                    </div>
                                </div>
